...
class ArgumentParser:
    def __init__(self):
        self.parser = argparse.ArgumentParser(description='Translate English PDF document to Chinese.')
        ...
        self.parser.add_argument('--document', type=str, help='PDF file to translate.')
        self.parser.add_argument('--file_format', type=str, help='The file format of translated document. Now supporting PDF and Markdown')
    ...
    def check_argument(self, args):
        if args.model_type == 'OpenAIModel':
            ...
            if not args.book:
                self.parser.error("--document is required")
